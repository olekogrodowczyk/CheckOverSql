...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220301204724_convertDatabaseInto1NFWithValueObject")]
    partial class convertDatabaseInto1NFWithValueObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Comparison", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Solution", "Solution")
                        .WithOne("Comparison")
                        .HasForeignKey("Domain.Entities.Comparison", "SolutionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Database", b =>
                {
                    b.OwnsOne("Domain.ValueObjects.ConnectionString", "ConnectionString", b1 =>
                        {
                            b1.Property<int>("DatabaseId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                            ...
                            b1.HasKey("DatabaseId");

                            b1.ToTable("Databases");
